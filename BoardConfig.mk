...
# ----------------------------------------------------- Stage 3: 图形栈
# external/mesa3d 使用 WayDroid-ATV 的 Mesa 26.1.8（lineage-18.1 分支）。
# 它是 Make + meson 交叉构建，android/Android.mk 直接产出
# /vendor/lib{64}/hw/vulkan.freedreno.so；Mesa 源码本身不做修改。
# 该 Android.mk 位于 Android 16 默认封锁的 external/ 目录，由
# vendor/extra/build/androidmk/allowlist.txt 放行。
# 宿主机需要 meson、ninja、python3-mako 和 python3-yaml。
